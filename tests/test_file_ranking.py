...
def test_FileRankingRepo_load__not_existing_ranking(tmp_path):
    ranking_manager = FileRankingRepo(tmp_path)
    difficulty = Difficulty(4, 6)
    assert ranking_manager.load(difficulty) == Ranking((), difficulty)


def test_FileRankingRepo_is_score_fit_into__not_full(tmp_path):
...
def test_FileRankingRepo_is_score_fit_into__full(tmp_path):
    difficulty = Difficulty(3, 6)
    ranking_manager = FileRankingRepo(tmp_path)
...
def test_FileRankingRepo_update__not_full(tmp_path):
...
def test_FileRankingRepo_update__overflow(tmp_path):
    difficulty = Difficulty(3, 6)
    ranking_manager = FileRankingRepo(tmp_path)
...
def test_FileRankingRepo_available_difficulties(tmp_path):
